                        ...
                        <div class="form-group row">
                            <div class="col-md-6">
                                <div class="input-group">
                                    ...
                                    <input type="text" v-model="buscar" @keyup.enter="listRole(1,buscar,criterio)" class="form-control" placeholder="Texto a buscar">
                                    <button type="submit" @click="listRole(1,buscar,criterio)" class="btn btn-primary"><i class="fa fa-search"></i> Buscar</button>
                                </div>
                            </div>
                        </div>
    ...
    export default {
        ...
        methods : {
            ...
            changePage(page,buscar,criterio){
                ...
                me.listRole(page,buscar,criterio);
            }
        },
        mounted() {
            this.listRole(1,this.buscar,this.criterio);
        }
    }
</script>
<style type="text/css">
